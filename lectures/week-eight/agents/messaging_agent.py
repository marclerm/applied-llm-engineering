...
class MessagingAgent(Agent):
    ...
    color = Agent.WHITE
    MODEL = os.getenv("MESSAGING_MODEL", os.getenv("PRICER_PREPROCESSOR_MODEL", "openai/gpt-5-nano"))
    ...
    def __init__(self):
        ...
        self.log(f"Messaging Agent initialized with {self.MODEL}")
    ...
    def push(self, text):
        ...
        if not self.pushover_user or not self.pushover_token:
            self.log("Pushover is not configured; notification was skipped")
            return False
